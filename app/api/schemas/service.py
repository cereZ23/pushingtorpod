...
class ServiceResponse(BaseModel):
    ...
    risk_score: Optional[float] = Field(None, description="Explainable risk score (0-100)")
    risk_level: Optional[str] = Field(None, description="Risk level (info/low/medium/high/critical)")
    risk_components: Optional[Dict] = Field(None, description="Breakdown of the factors behind the score")

...
class TestUpdatePhase:
    ...
    def test_creates_new_phase_result(self, mock_sl):
        ...
        _update_phase(mock_db, scan_run_id=1, phase_id="0", status=PhaseStatus.RUNNING)
    ...
    def test_updates_existing_phase_result(self, mock_sl):
        ...
        _update_phase(mock_db, scan_run_id=1, phase_id="0", status=PhaseStatus.COMPLETED, stats={"count": 5})
    ...
    def test_sets_error_on_failure(self, mock_sl):
        ...
        _update_phase(mock_db, scan_run_id=1, phase_id="1", status=PhaseStatus.FAILED, error="Timed out after 300s")

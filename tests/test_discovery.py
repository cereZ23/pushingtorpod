...
def test_run_dnsx_no_subdomains():
    ...
    subfinder_result = {"subdomains": [], "tenant_id": 1}
...
def test_process_discovery_results():
    ...
    dnsx_result = {
        "resolved": [{"host": "sub1.example.com", "a": ["1.2.3.4"]}, {"host": "sub2.example.com", "a": ["1.2.3.5"]}],
        "tenant_id": 1,
    }
...
{"name": "sub3.example.com", "domain": "example.com"}"""
    ...
    with (
        patch("app.utils.secure_executor.SecureToolExecutor") as MockExecutor,
...
def test_merge_discovery_results_no_overlap():
    ...
    amass_result = {"subdomains": ["sub3.example.com", "sub4.example.com"], "tenant_id": 1, "source": "amass"}
...
def test_merge_discovery_results_with_overlap():
    ...
    subfinder_result = {"subdomains": ["sub1.example.com", "sub2.example.com", "sub3.example.com"], "tenant_id": 1}
...
def test_merge_discovery_results_all_overlap():
    ...
    amass_result = {"subdomains": ["sub1.example.com", "sub2.example.com"], "tenant_id": 1, "source": "amass"}

...
describe("getRiskScoreClasses", () => {
  ...
  it("handles boundary score 81 as red", () => {
    const classes = getRiskScoreClasses(81);
    expect(classes.bg).toBe("bg-red-500");
  });

  it("handles boundary score 61 as orange", () => {
    const classes = getRiskScoreClasses(61);
    expect(classes.bg).toBe("bg-orange-500");
  });

  it("handles boundary score 41 as yellow", () => {
    const classes = getRiskScoreClasses(41);
    expect(classes.bg).toBe("bg-yellow-500");
  });

  it("handles boundary score 21 as blue", () => {
    const classes = getRiskScoreClasses(21);
    expect(classes.bg).toBe("bg-blue-500");
  });

...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Scan Authorizations",
        to: "/settings/scan-authorizations",
        activeNames: ["ScanAuthorizations"],
        adminOnly: true,
      },
      {
        label: "Tenants",
...
const itemIcons: Record<string, string[]> = {
  ...
  "/settings/report-schedules": ["M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"],
...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-dark-bg-primary">
    ...
    <nav
      ...
      class="bg-white dark:bg-dark-bg-secondary border-b border-gray-200 dark:border-dark-border"
    >
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
          <div class="flex items-center">
            ...
            <h1
              class="text-xl font-bold text-gray-900 dark:text-dark-text-primary"
            >
              EASM Platform
            </h1>
            ...
            <div class="relative ml-6 hidden md:block">
              <div class="relative">
                <svg
                  class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-dark-text-tertiary"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <input
                  ...
                  @focus="
                    searchQuery.length >= 2 && (showSearchDropdown = true)
                  "
                  @blur="closeSearch"
                  type="text"
              ...
              >
                <div
                  v-if="isSearching"
                  class="p-4 text-center text-sm text-gray-500 dark:text-dark-text-secondary"
                >
                  Searching...
                </div>
                <div
                ...
                <ul
                  v-else
                  class="max-h-80 overflow-y-auto divide-y divide-gray-100 dark:divide-dark-border"
                >
                  <li
